...
class GUI_Condition:
    def __init__(self, parent_frame, controller, mode="add", selected=None):
        ...
        self.text_entry_condition = self.create_textbox(input_frame)

        # Campo: Acción
        self.create_label(input_frame, "Acción")
        self.text_entry_action = self.create_textbox(input_frame)
    ...
    def add_condition(self, text_logic_exp, text_action, text_var, text_constants):
        self.controller.add_condition(text_logic_exp, text_action, text_var, text_constants)
        self.controller.toggle_frame()

    def edit_condition(self, text_logic_exp, text_action, text_var, text_constants):
        self.controller.edit_condition(text_logic_exp, text_action, text_var, text_constants, self.selected)
        self.controller.toggle_frame()
